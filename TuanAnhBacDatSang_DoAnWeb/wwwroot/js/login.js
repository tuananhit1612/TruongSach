...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.querySelector('.TruongSach-auth-form');
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!username || !password) {
            ...
            if (window.TruongSach) {
                TruongSach.showToast('Vui lòng nhập đầy đủ thông tin', 'error');
            }
            return false;
        }
    ...
    // setTimeout(() => {
    //     if (window.TruongSach) {
    //         TruongSach.showToast('Demo: admin/123456 hoặc user1/123456', 'info', 8000);
    //     }
    // }, 1000);
});